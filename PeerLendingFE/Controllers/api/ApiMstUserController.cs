...
namespace PeerLendingFE.Controllers.api
{
    public class ApiMstUserController : Controller
	{
		...
		public async Task<IActionResult> GetUserById(string id)
		{
			...
			var response = await _httpClient.GetAsync("https://localhost:7061/rest/v1/user/GetUserId?id=" + id);
		...
		public async Task<IActionResult> AddUser([FromBody] ReqRegisterDto reqRegisterDto)
		{
			...
			var response = await _httpClient.PostAsync("https://localhost:7061/rest/v1/user/Register", content);
		...
		public async Task<IActionResult> UpdateUser(string id, [FromBody] ReqMstUserDto reqMstUserDto)
		{
			...
			var response = await _httpClient.PutAsync($"https://localhost:7061/rest/v1/user/UpdatebyAdmin?id=" + id, content);
		...
		public async Task<IActionResult> DeleteUser(string id)
		{
			...
			var response = await _httpClient.DeleteAsync($"https://localhost:7061/rest/v1/user/Delete?id=" + id);
